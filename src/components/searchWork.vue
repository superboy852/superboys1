<template>
    <div>
      ...
      <div class="base-header-item">
        <div class="search-work position-re flex align-center rdx-p-l-10"
                ...
                <div class="flex flex-direction rdx-flex-1 rdx-p-r-30">
                  ...
                  <div v-if="!show.searchGo"
                    ...
                    <div class="flex flex-direction rdx-font-12 rdx-p-l-12">
                      <span class="rdx-tips-color rdx-line-height-26 rdx-flex-1" style="width: 260px;">{{live.room_title}}</span>
                    </div>
                  </div>
                </div>
                <div class="flex flex-direction rdx-flex-1">
  ...
  <style lang="scss" scoped>
    .search-work{
      ...
      /deep/.el-input__inner:hover{border-color:$rdx-primary;border-radius:4px;}
      ...
      @keyframes buttonOver{
      		0%{box-shadow:inset 0 0px 6px 0px #fe6161;}
      		100%{box-shadow:inset 0 0px 6px 4px #fe6161;}
      }
