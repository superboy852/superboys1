<template>
  <div class="w-100">
    ...
    <div id="sellDataIds" style="width: 100%; height: 350px;"></div>
    <slot></slot>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      async getFans() {
        ...
        console.log('测试室', data)
        if (data != undefined) {
          this.volumeChart = data.volume_chart
          let dates = [];
          let firstVolume = [];
          let secondVolume = [];
          ...
          var chartDom = document.getElementById('sellDataIds')
