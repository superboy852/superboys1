...
<!--            <span class="rdx-m-l-16 rdx-m-t-4">
      ...
      <el-table-column align="center" prop="follower_count_incr" label="粉丝增量" sortable="custom" width="130"></el-table-column>
      <el-table-column align="center" prop="comment_count" label="评论数" sortable="custom" width="130"></el-table-column>
      <el-table-column align="center" prop="comment_count_incr" label="评论增量" width="130" sortable="custom"></el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      async loadData() {
        ...
        const {
          data
        } = await this.$get('/api/rank/author/commentsAuthorRanking', this.params)
        this.tableData = []
        if(data!=undefined){
          this.loading = false
          this.params.page = 2
