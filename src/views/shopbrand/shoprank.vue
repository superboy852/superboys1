<template>
  <div class="box">
    <div class="select-box2">
      ...
      <goods-class @onProduct="handleProductCate" classShow='1' class="rdx-p-t-5" searchPlaceholder="请输入品牌关键词"></goods-class>
    </div>
    ...
    <el-table v-loading="loading" :data="tableData" class="sticky-head" @sort-change="handlesortChange" @row-click="jumpurl">
      <template slot="empty" v-if="tableData == ''">
      ...
      <el-table-column label="小店">
        <template slot-scope="{ row }">
          <div class="info rdx-flex info-two">
            <img class="circularHead" :src="row.shop_icon"  />
      ...
      <el-table-column align="center" prop="product_count" label="推广商品数" width="130"></el-table-column>
      ...
      <el-table-column align="center" prop="average_conversion_rate" sortable="custom" label="销售转化率" width="130">
        <template slot-scope="scope">
