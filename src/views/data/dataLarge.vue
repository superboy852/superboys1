<template>
  <div class="data-large flex justify-center align-center" ref="largeBody">
      ...
      <div class="left flex flex-direction">
        <div class="left-user flex flex-direction rdx-light-color position-re">
          <div class="flex align-center">
            <img src="../../assets/imgs/logo_3.png" style="width: 200px; height: 70px;">
            <div class="back-button flex rdx-light-color justify-center align-center rdx-m-l-16 button-a" style="margin-top: 5px;" @click="backList">
              <span>guanxingshu.com</span>
              <i class="iconfont icon-e616" style="margin-top: 3px;"></i>
            </div>
            ...
            <div class="user-c flex justify-between align-center" v-if="show.blockShow">
              ...
              <el-popover placement="bottom" width="170" trigger="hover" transition="ease"
                ...
                <div class="flex justify-center">
                  <div class="flex flex-direction align-center rdx-p-t-10">
                    <div id="qrcode2" ref="qrcode2"></div>
                    <span class="rdx-font-14 rdx-p-t-6">抖音扫码查看达人</span>
                  </div>
                </div>
        ...
        <div class="flex justify-between">
          <div class="left-item flex justify-between">
            <div class="flex w-100 flex-direction position-re">
              <div class="left-watch data-bg flex rdx-m-t-24 flex-direction">
                <div class="flex justify-between rdx-p-b-40" style="border-bottom: 1px solid #595A64;">
              ...
              <div class="position-ab rdx-radius-30 data-bg flex flex-direction rdx-m-t-24 rdx-p-26 barrage-more"
                ...
                <div class="flex justify-between rdx-p-b-36" style="border-bottom: 1px solid #595A64;">
                  <div class="flex watch-top align-center">
                    <div class="watch-ico flex align-center justify-center round">
              ...
              <div class="left-view flex flex-direction rdx-m-t-24 position-re">
                <div class="flex justify-between rdx-p-b-24 position-ab">
                  <div class="flex watch-top align-center">
                    <div class="watch-ico2 flex align-center justify-center round">
          ...
          <div class="goods data-bg flex flex-direction rdx-m-t-24" style="padding: 20px 0px;">
            <div class="flex justify-between rdx-p-lr-20">
            ...
            <div class="flex flex-direction rdx-p-lr-20">
            ...
            <div class="goods-box">
              ...
              <div style="height: 100%; overflow-y: auto; width: 810px;" ref="putawayId" @mouseenter="putawayEnter"
                @mouseleave="putawayLeave">
                <div class="flex rdx-tips-color align-center" style="border-bottom: 1px solid #595A64; height: 80px;"
                  v-for="(putawayS,index2) in getData.putawayData" :key="index2">
                  <div class="w-50 rdx-p-l-40 rdx-p-t-14 rdx-p-b-14 rdx-p-l-40 flex align-center">
                    <img :src="putawayS.image" style="width: 52px; height: 52px;"
                      onerror="javascript:this.src='http://douyin.guanxingshu.com/img/no_img.png'">
                    <span class="rdx-p-l-18" style="color: #AAAAAF;">{{putawayS.product_title}}</span>
                  </div>
                  <div class="w-15 rdx-p-l-20 rdx-p-t-14 rdx-p-b-14 rdx-text-center">{{putawayS.final_price}}</div>
                  <div class="w-15 rdx-p-l-20 rdx-p-t-14 rdx-p-b-14 rdx-text-center">{{putawayS.volume}}</div>
                  <div class="w-15 rdx-p-l-20 rdx-p-t-14 rdx-p-b-14 rdx-text-center">{{putawayS.amount}}</div>
      ...
      <div class="right-c">
        <div class="living-ok data-bg rdx-light-color flex" style="height: 281px;">
          ...
          <div class="flex rdx-p-l-16 flex-direction position-re">
            <span class="rdx-font-26 link-primary rdx-line-3" @click="linkLiving">{{getData.largeInfor.room.user_count}}宝贝 正在围观
        ...
        <div class="living-ok data-bg rdx-m-t-25" style="height: 287px;">
          <div class="flex watch-top align-center rdx-light-color rdx-p-b-25" style="border-bottom: 1px solid #595A64;">
            <div class="watch-ico flex align-center justify-center round">
        ...
        <div class="living-ok data-bg rdx-m-t-25 position-re">
          ...
          <div class="flex justify-between rdx-p-l-40 align-center rdx-light-color position-ab rdx-flex-1"
            style="top: 70px; left: -20px; width: 100%;">
            <div class="flex align-center">
    ...
    <div class="video-2 flex align-center justify-center" v-if="show.videoShow">
      <video id="videoElement" controls autoplay width="310px" height="550px" style="border-radius: 50px; z-index: 11;"></video>
      <img src="../../assets/imgs/data_living_3.png" style="width: 100%; height: 550px;" class="video-img">
      <div class="position-ab button-a" style="right: -10px; top: 0px; z-index: 100;">
        <i style="background-color: #FFFFFF; border-radius: 30px;" class="iconfont icon-e686 rdx-font-20" @click="videoClose"></i>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.getResize()
      document.onvisibilitychange = () => { //切换页面时关闭定时器
        if (document.visibilityState == "visible") {
          console.log("visible111111")
          this.getGoodsList()
          this.barrageTime = setInterval(() => {
            this.getBarrage()
          }, 10000)
    ...
    methods: {
      //返回列表
      backList(){
        this.$router.push({path:'/living/redboard'})
      },
      qrcode() {
      ...
      async getLargeInfor() {
        ...
        if (data != '' || data != undefined) {
          ...
          this.getData.largeInfor.author.follower_count = tools.numberVerify(this.getData.largeInfor.author.follower_count)
        ...
        this.setTimePutaway = setInterval(() => {
          ...
          if (scrollHeight <= (scrollTop + objHeight + 10)) {
            ...
            this.scrollToGo = setInterval(() => {
              this.$refs.putawayId.scrollTo(this.$refs.putawayId.scrollTop, this.$refs.putawayId.scrollTop +=
                10)
              falg += 1
              if (falg >= 8) {
                falg = 0
        ...
        if (data != undefined || data.list != '') {
          ...
          this.setTimePutaway = setInterval(() => {
            ...
            if (scrollHeight <= (scrollTop + objHeight + 10)) {
              ...
              this.scrollToGo = setInterval(() => {
                this.$refs.putawayId.scrollTo(this.$refs.putawayId.scrollTop, this.$refs.putawayId
                  .scrollTop += 10)
                falg += 1
                if (falg >= 8) {
                  falg = 0
